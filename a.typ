#table(columns: (auto, auto), inset: 5pt, align: center, [attr1_1], figure(image("img/hist_attr1_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [sinc1_1], figure(image("img/hist_sinc1_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [intel1_1], figure(image("img/hist_intel1_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [fun1_1], figure(image("img/hist_fun1_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [amb1_1], figure(image("img/hist_amb1_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [shar1_1], figure(image("img/hist_shar1_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [attr2_1], figure(image("img/hist_attr2_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [sinc2_1], figure(image("img/hist_sinc2_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [intel2_1], figure(image("img/hist_intel2_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [fun2_1], figure(image("img/hist_fun2_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [amb2_1], figure(image("img/hist_amb2_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [shar2_1], figure(image("img/hist_shar2_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [attr3_1], figure(image("img/hist_attr3_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [sinc3_1], figure(image("img/hist_sinc3_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [intel3_1], figure(image("img/hist_intel3_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [fun3_1], figure(image("img/hist_fun3_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [amb3_1], figure(image("img/hist_amb3_1.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [attr1_2], figure(image("img/hist_attr1_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [sinc1_2], figure(image("img/hist_sinc1_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [intel1_2], figure(image("img/hist_intel1_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [fun1_2], figure(image("img/hist_fun1_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [amb1_2], figure(image("img/hist_amb1_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [shar1_2], figure(image("img/hist_shar1_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [attr3_2], figure(image("img/hist_attr3_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [sinc3_2], figure(image("img/hist_sinc3_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [intel3_2], figure(image("img/hist_intel3_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [fun3_2], figure(image("img/hist_fun3_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [amb3_2], figure(image("img/hist_amb3_2.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [pf_o_att], figure(image("img/hist_pf_o_att.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [pf_o_sin], figure(image("img/hist_pf_o_sin.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [pf_o_int], figure(image("img/hist_pf_o_int.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [pf_o_fun], figure(image("img/hist_pf_o_fun.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [pf_o_amb], figure(image("img/hist_pf_o_amb.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [pf_o_sha], figure(image("img/hist_pf_o_sha.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [attr_o], figure(image("img/hist_attr_o.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [sinc_o], figure(image("img/hist_sinc_o.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [intel_o], figure(image("img/hist_intel_o.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [fun_o], figure(image("img/hist_fun_o.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [amb_o], figure(image("img/hist_amb_o.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [shar_o], figure(image("img/hist_shar_o.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [round], figure(image("img/hist_round.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [age_o], figure(image("img/hist_age_o.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [age], figure(image("img/hist_age.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [imprace], figure(image("img/hist_imprace.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [goal], figure(image("img/hist_goal.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [date], figure(image("img/hist_date.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [go_out], figure(image("img/hist_go_out.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [exphappy], figure(image("img/hist_exphappy.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [expnum], figure(image("img/hist_expnum.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [sports], figure(image("img/hist_sports.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [tvsports], figure(image("img/hist_tvsports.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [exercise], figure(image("img/hist_exercise.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [dining], figure(image("img/hist_dining.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [museums], figure(image("img/hist_museums.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [art], figure(image("img/hist_art.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [hiking], figure(image("img/hist_hiking.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [gaming], figure(image("img/hist_gaming.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [clubbing], figure(image("img/hist_clubbing.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [reading], figure(image("img/hist_reading.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [tv], figure(image("img/hist_tv.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [theater], figure(image("img/hist_theater.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [movies], figure(image("img/hist_movies.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [concerts], figure(image("img/hist_concerts.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [music], figure(image("img/hist_music.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [shopping], figure(image("img/hist_shopping.png"),))
#table(columns: (auto, auto), inset: 5pt, align: center, [yoga], figure(image("img/hist_yoga.png"),))
...
#figure(image("img/corr_1_1.png"))
#figure(image("img/corr_1_2.png"))
#figure(image("img/corr_2_1.png"))
#figure(image("img/corr_3_1.png"))
#figure(image("img/corr_2_1.png"))
#figure(image("img/corr_o.png"))
#figure(image("img/corr_pf_o.png"))
#figure(image("img/corr_scores.png"))